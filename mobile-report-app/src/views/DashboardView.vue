              ...
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd class="text-lg font-medium text-gray-900">6.5</dd>
                  </dl>
                </div>
              </div>
            </div>
          ...
          <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
              <div class="flex items-center">
                ...
                <div class="ml-5 w-0 flex-1">
                  <dl>
                    <dt class="text-sm font-medium text-gray-500 truncate">Reports This Week</dt>
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-gray-500 truncate">Start or stop timer</p>
              </div>
            </router-link>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-gray-500 truncate">See active work orders</p>
              </div>
            </router-link>
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                ...
                <p class="text-sm text-gray-500 truncate">New digital report</p>
              </div>
            </router-link>
          </div>
        </div>
